...
//  GuideStreamTVTV
//
//  tvOS-adapted port of the iOS hero carousel. Same heterogeneous tile
//  rail (media + sports + news) but without UIKit haptics (unavailable on
//  tvOS) and with focusable Buttons so the Siri Remote can step through
//  each card.
//
